...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Use the existing client (with user auth) to read the profile.
    // Users are permitted to read their own profile via RLS.
    ...
    // Map status codes to generic user-friendly messages.
