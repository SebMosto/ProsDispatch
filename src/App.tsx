...
const JobInvitePage = lazy(() => import('./pages/public/JobInvitePage'));
...
const AppShell = ({ children }: { children: ReactNode }) => {
  ...
  const isPublicRoute = pathname.startsWith('/pay/') || pathname.startsWith('/job-invite/');
      ...
      <AppShell>
        <Suspense fallback={<PageLoader />}>
          <Routes>
            ...
            <Route path={routePatterns.publicJobInvite} element={<JobInvitePage />} />
