...
const AppShell = ({ children }: { children: ReactNode }) => {
  ...
  const isPublicJobApproval = pathname.startsWith('/jobs/approve/');

  if (isPublicInvoice || isPublicJobApproval) {
    return (
      ...
      <AppShell>
        <Suspense fallback={<PageLoader />}>
          <Routes>
            ...
            <Route path={routePatterns.publicJobApproval} element={<JobApprovalPage />} />
